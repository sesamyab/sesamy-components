...
<Base>
  <Clickable
    class={twMerge(
      'inline-flex ring-2 ring-transparent focus:ring-primary/25 active:enabled:translate-y-px border border-transparent items-center justify-center outline-none rounded-md transition-colors duration-200 ease-in-out',
