...
<label class="p-3 @3xl:p-4 row-left gap-4 w-full relative cursor-pointer" for={id} {...rest}>
  ...
  <div
    class="w-4 h-4 rounded-full transition-all bg-white dark:bg-black border border-[#E7E7EC] dark:border-gray-500 relative ring ring-transparent peer-focus-visible:ring-primary/20 peer-checked:border-primary peer-checked:bg-primary"
  >
    <div
